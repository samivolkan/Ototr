...
class DummyData {
  ...
  static const List<PackagePlan> packages = [
    ...
    PackagePlan(
      ...
      maxDiscountWarning:
          'Maksimum iskonto uyarısı: Bölge müdürü onayı gerekir',
      ...
      case 'kaporta':
        return const [
          InspectionChecklistItem(
              id: 'kaput',
              title: 'Ön kaput',
              result: ChecklistResultStatus.normal,
              note: 'Mikron değeri standart aralıkta.',
              photoRequired: false,
              severity: 0),
          InspectionChecklistItem(
              id: 'sag-on-camurluk',
              title: 'Sağ ön çamurluk',
              result: ChecklistResultStatus.attention,
              note: 'Lokal boya şüphesi.',
              photoRequired: true,
              severity: 1),
          InspectionChecklistItem(
              id: 'sol-on-camurluk',
          ...
          InspectionChecklistItem(
              ...
              title: 'Bagaj kapağı',
              result: ChecklistResultStatus.attention,
              note: 'Sök-tak izi kontrol edilmeli.',
              photoRequired: true,
              severity: 1),
          InspectionChecklistItem(
              id: 'mikron',
              title: 'Boya mikron değeri',
              result: ChecklistResultStatus.normal,
              note: '92-118 mikron aralığı.',
              photoRequired: false,
              severity: 0),
          InspectionChecklistItem(
              id: 'islem',
              title: 'Değişen/sökülen/boyalı/lokal boyalı/işlemli',
              result: ChecklistResultStatus.attention,
              note: 'Sağ ön çamurluk lokal boyalı olabilir.',
              photoRequired: true,
              severity: 1),
        ];
      case 'motor':
        return const [
          ...
          InspectionChecklistItem(
              id: 'turbo',
              title: 'Turbo kontrolü',
              result: ChecklistResultStatus.attention,
              note: 'Basınç testi önerilir.',
              photoRequired: false,
              severity: 1),
          InspectionChecklistItem(
              id: 'sogutma',
              title: 'Hararet/soğutma',
              result: ChecklistResultStatus.normal,
              note: '',
              photoRequired: false,
              severity: 0),
          InspectionChecklistItem(
              ...
              title: 'Conta şüphesi',
              result: ChecklistResultStatus.normal,
              note: 'Kaçak belirtisi yok.',
              photoRequired: false,
              severity: 0),
          InspectionChecklistItem(
              id: 'duman',
              title: 'Duman kontrolü',
              result: ChecklistResultStatus.normal,
              note: '',
              photoRequired: false,
              severity: 0),
      ...
      case 'mekanik':
        return const [
          ...
          InspectionChecklistItem(
              ...
              title: 'Süspansiyon',
              result: ChecklistResultStatus.attention,
              note: 'Sağ ön amortisör takip edilmeli.',
              photoRequired: false,
              severity: 1),
          InspectionChecklistItem(
              id: 'fren',
          ...
          InspectionChecklistItem(
              id: 'test-surusu',
              title: 'Test sürüşü notu',
              result: ChecklistResultStatus.notChecked,
              note: 'Test sürüşü bekliyor.',
              photoRequired: false,
              severity: 0),
        ];
      default:
        return const [
          InspectionChecklistItem(
              ...
              title: 'Genel kontrol',
              result: ChecklistResultStatus.notChecked,
              note: 'Teknisyen kontrolü bekleniyor.',
              photoRequired: false,
              severity: 0),
          InspectionChecklistItem(
              id: 'bulgu-notu',
  ...
  static List<InspectionModule> modules = [
    InspectionModule(
        id: 'kaporta',
        name: 'Kaporta & Boya',
        status: ModuleStatus.criticalFinding,
        technician: technician.fullName,
        hasEvidence: true,
        checklistItems: checklistFor('kaporta')),
    InspectionModule(
        id: 'motor',
        name: 'Motor',
        ...
        technician: technician.fullName,
        hasEvidence: true,
        checklistItems: checklistFor('motor')),
    InspectionModule(
        id: 'mekanik',
        name: 'Mekanik',
        ...
        technician: technician.fullName,
        hasEvidence: false,
        checklistItems: checklistFor('mekanik')),
    InspectionModule(
        id: 'obd',
        name: 'OBD/Beyin Kontrolü',
        status: ModuleStatus.pending,
        technician: technician.fullName,
        hasEvidence: false,
        checklistItems: checklistFor('obd')),
    InspectionModule(
        id: 'airbag',
        name: 'Airbag',
        status: ModuleStatus.pending,
        technician: technician.fullName,
        hasEvidence: false,
        checklistItems: checklistFor('airbag')),
    InspectionModule(
        id: 'conta',
        ...
        technician: technician.fullName,
        hasEvidence: false,
        checklistItems: checklistFor('conta')),
    InspectionModule(
        id: 'fren',
        ...
        technician: technician.fullName,
        hasEvidence: false,
        checklistItems: checklistFor('fren')),
    InspectionModule(
        id: 'donanim',
        name: 'İç/Dış Donanım',
        status: ModuleStatus.pending,
        technician: technician.fullName,
        hasEvidence: false,
        checklistItems: checklistFor('donanim')),
    InspectionModule(
        id: 'fotograf',
        name: 'Fotoğraf Kanıtları',
        status: ModuleStatus.inProgress,
        technician: technician.fullName,
        hasEvidence: false,
        checklistItems: checklistFor('fotograf')),
  ];
  ...
  static const List<PhotoEvidence> photos = [
    ...
    PhotoEvidence(
        ...
        isRequired: true,
        isUploaded: false,
        uploadQueueLabel: 'Fotoğraf yükleme kuyruğu'),
    PhotoEvidence(
        id: 'cockpit',
        title: 'İç kokpit',
        isRequired: true,
    ...
    PhotoEvidence(
        id: 'vin',
        title: 'Şasi/VIN etiketi',
        isRequired: true,
        isUploaded: false,
        uploadQueueLabel: 'Senkronizasyon bekliyor'),
    PhotoEvidence(
        id: 'plate',
        title: 'Plaka',
        isRequired: true,
    ...
    PhotoEvidence(
        id: 'damage',
        title: 'Hasarlı bölgeler',
        isRequired: false,
        isUploaded: false,
        uploadQueueLabel: 'Opsiyonel'),
    PhotoEvidence(
        id: 'critical',
        title: 'Kritik bulgu fotoğrafları',
        isRequired: false,
        isUploaded: true,
        uploadQueueLabel: 'Yüklendi'),
  ];
  ...
  static WorkOrder workOrder = WorkOrder(
    ...
    notes:
        'Premium Güven Paketi kapsamında rapor öncesi fotoğraf eksikleri tamamlanmalı.',
    auditLogs: [
      AuditLog(
          id: 'a1',
          userName: 'Ahmet Demir',
          action: 'Araç kabul edildi',
          createdAt: DateTime(2026, 5, 24, 10, 15)),
      AuditLog(
          id: 'a2',
          userName: 'Murat Kaya',
          action: 'Ekspertiz başlatıldı',
          createdAt: DateTime(2026, 5, 24, 10, 28)),
    ],
    ...
    technicianStartEvidenceReady: true,
    externalQueriesReady: true,
  ...
  static List<WorkOrder> workOrders = [
    ...
    WorkOrder(
      ...
      editRequestPending: false,
      appointmentReady: true,
      vehicleIntakeReady: false,
      customerConsentReady: false,
      packageApproved: false,
      technicalAssignmentReady: false,
    ...
    WorkOrder(
      ...
      notes:
          'Rapor basıldı ve müşteriye teslim edildi. Değişiklik için yönetici revizyon talebi gerekir.',
      auditLogs: const [],
  ...
  static Report report = Report(
    ...
    riskSummary:
        'Orta risk: kaporta lokal boya şüphesi ve süspansiyon takip önerisi.',
    technicianNote:
        'Fotoğraf eksikleri tamamlandığında şube onayına gönderilebilir.',
